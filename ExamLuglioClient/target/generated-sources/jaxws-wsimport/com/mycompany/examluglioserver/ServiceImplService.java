 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://examluglioserver.mycompany.com/", wsdlLocation = "http://localhost:8080/MovieService?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://examluglioserver.mycompany.com/", "ServiceImplService");
    ...
    public com.mycompany.examluglioserver.Service getServiceImplPort() {
        return super.getPort(new QName("http://examluglioserver.mycompany.com/", "ServiceImplPort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServiceImplPort")
    public com.mycompany.examluglioserver.Service getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://examluglioserver.mycompany.com/", "ServiceImplPort"), Service.class, features);
    }
