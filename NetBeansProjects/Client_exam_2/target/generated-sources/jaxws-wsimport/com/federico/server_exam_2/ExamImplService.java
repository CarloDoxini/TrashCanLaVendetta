 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://server_exam_2.federico.com/", wsdlLocation = "http://localhost:8000/MovieService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://server_exam_2.federico.com/", "ExamImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/MovieService?wsdl");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://server_exam_2.federico.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server_exam_2.federico.com/", "ExamImplPort"), Exam.class, features);
    }
