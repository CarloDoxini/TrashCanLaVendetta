 ...
 * generated in the com.mycompany.wsexample2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudentsResponse_QNAME = new QName("http://wsexample2.mycompany.com/", "getStudentsResponse");
    private final static QName _HelloResponse_QNAME = new QName("http://wsexample2.mycompany.com/", "helloResponse");
    private final static QName _GetStudents_QNAME = new QName("http://wsexample2.mycompany.com/", "getStudents");
    private final static QName _HelloStudent_QNAME = new QName("http://wsexample2.mycompany.com/", "helloStudent");
    private final static QName _Hello_QNAME = new QName("http://wsexample2.mycompany.com/", "hello");
    private final static QName _HelloStudentResponse_QNAME = new QName("http://wsexample2.mycompany.com/", "helloStudentResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.wsexample2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsexample2.mycompany.com/", name = "getStudentsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsexample2.mycompany.com/", name = "helloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsexample2.mycompany.com/", name = "getStudents")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsexample2.mycompany.com/", name = "helloStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsexample2.mycompany.com/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsexample2.mycompany.com/", name = "helloStudentResponse")
