 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://wsexample2.mycompany.com/", wsdlLocation = "http://localhost:8080/ws2?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://wsexample2.mycompany.com/", "WSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ws2?wsdl");
    ...
    public WS getWSImplPort() {
        return super.getPort(new QName("http://wsexample2.mycompany.com/", "WSImplPort"), WS.class);
    }
    ...
    public WS getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsexample2.mycompany.com/", "WSImplPort"), WS.class, features);
    }
